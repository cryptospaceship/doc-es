...
La mejor manera de describir a una cadena de bloques es pensar en una base de datos de transacciones. Esta base de datos esta dividida en Bloques, es decir, en cada bloque entran una sierta cantidad de transacciones. 
Cada transaccion representa una escritura en esta "Base de datos" que describimos en un pricipio, esta escritura va a quedar reflejada en la cadena de bloques eternamente y no tiene manera de modificarse una vez que se escribio.
